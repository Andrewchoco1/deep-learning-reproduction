_base_ = [
    '/mnt/vde/FW/code/P2PFormer/p2pformer/configs/scp/config.py',
...
# ==================== 关键优化在这里 ====================
data = dict(
    samples_per_gpu=6,          # 如果显存充足，可尝试改为 3 或 4
    workers_per_gpu=8,          # 👈 从 2 提高到 8，大幅提升数据加载速度
...
# learning policy
lr_config = dict(policy='step', step=[180])
